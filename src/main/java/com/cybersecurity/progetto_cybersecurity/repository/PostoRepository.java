...
public interface PostoRepository extends JpaRepository<Posto, Long> {
    ...
    @Query("SELECT new com.cybersecurity.progetto_cybersecurity.controller.dto.VoloPostoDTO(vp.stato,vp.posto.numeroPosto) FROM Posto p INNER JOIN VoloPosto vp ON p.id=vp.posto.id INNER JOIN Volo v ON vp.volo.id=v.id WHERE v.codiceVolo=:codiceVolo")
